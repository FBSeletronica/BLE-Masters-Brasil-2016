...
#define LED_D5_TRIS               TRISA2
#define LED_D5_LAT                LATA2
#define LED_D5_PORT               RA2
#define LED_D5_ANS                ANSA2
#define LED_D5_SetHigh()    do { LATA2 = 1; } while(0)
#define LED_D5_SetLow()   do { LATA2 = 0; } while(0)
#define LED_D5_Toggle()   do { LATA2 = ~LATA2; } while(0)
#define LED_D5_GetValue()         RA2
#define LED_D5_SetDigitalInput()    do { TRISA2 = 1; } while(0)
#define LED_D5_SetDigitalOutput()   do { TRISA2 = 0; } while(0)

#define LED_D5_SetAnalogMode()   do { ANSA2 = 1; } while(0)
#define LED_D5_SetDigitalMode()   do { ANSA2 = 0; } while(0)
...
// get/set PWM4OUT aliases
#define PWM4OUT_TRIS               TRISC7
#define PWM4OUT_LAT                LATC7
#define PWM4OUT_PORT               RC7
#define PWM4OUT_ANS                ANSC7
#define PWM4OUT_SetHigh()    do { LATC7 = 1; } while(0)
#define PWM4OUT_SetLow()   do { LATC7 = 0; } while(0)
#define PWM4OUT_Toggle()   do { LATC7 = ~LATC7; } while(0)
#define PWM4OUT_GetValue()         RC7
#define PWM4OUT_SetDigitalInput()    do { TRISC7 = 1; } while(0)
#define PWM4OUT_SetDigitalOutput()   do { TRISC7 = 0; } while(0)

#define PWM4OUT_SetAnalogMode()   do { ANSC7 = 1; } while(0)
#define PWM4OUT_SetDigitalMode()   do { ANSC7 = 0; } while(0)
